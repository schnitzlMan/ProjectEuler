...
def getCollatzLength(inVal):
    #print('getCollatzLength - inVal', inVal)
    #print(iterationsList)
    if iterationsList[inVal] != 0:
        #print('found This in the List ')
    ...
    if lengthTempList > 0:
        for idx, val in enumerate(tempList):
            ...
            #print( idx, val, iterationsList[val])        
    #iterationsList[inVal] = numIterations+1
    #print(iterationsList[inVal])
    return iterationsList[inVal] 
